...
public class Auxiliar {
    ...
    public static boolean carregarProntuario() {
        ...
        try {
            ...
            if(Auxiliar.meusMedicamentos.size()!=Auxiliar.prontuario.getMedicamentos().size())  Auxiliar.meusMedicamentos=Auxiliar.prontuario.getMedicamentos();
            return retorno;
        }
    ...
    public static int adicionarRiscos(List<Risco>rs) {
        int retorno = 0;
        Log.i("RS",rs.size()+"");
        try {
            for (Risco risco : rs) {
                Log.i("Risco Rs",risco.getNome());
                StringBuilder entidade = new StringBuilder();
                entidade.append("prontuarios/pacientes/");
                entidade.append(paciente.getId());
                entidade.append("/riscos");
    ...
    public static int adicionarRiscos(Risco risco) {
